...
use Behastan202606\Symfony\Component\Finder\Finder;
...
final class BehatMetafilesFinder
{
    ...
    private static function createFinder(array $directories): Finder
    {
        ...
        return Finder::create()->files()->notPath('vendor')->notPath('node_modules')->notPath('Fixture')->sortByName()->in($directories);
    }
}
