...
final class DuplicatedScenarioNamesRule implements RuleInterface
{
    /**
     * @readonly
     * @var \Rector\Behastan\Analyzer\DuplicatedScenarioNamesAnalyzer
     */
    private $duplicatedScenarioNamesAnalyzer;
    public function __construct(DuplicatedScenarioNamesAnalyzer $duplicatedScenarioNamesAnalyzer)
    {
        $this->duplicatedScenarioNamesAnalyzer = $duplicatedScenarioNamesAnalyzer;
    }
    /**
