...
class ExampleNode implements ScenarioInterface, NamedScenarioInterface
{
     ...
     */
    public function __construct(string $text, array $tags, array $outlineSteps, array $tokens, int $line, ?string $outlineTitle = null, ?int $index = null)
    {
        $this->text = $text;
        $this->tags = $tags;
