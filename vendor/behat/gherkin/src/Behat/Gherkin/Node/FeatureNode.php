 ...
 */
namespace Behastan202606\Behat\Gherkin\Node;
...
class FeatureNode implements KeywordNodeInterface, TaggedNodeInterface
{
     ...
     * @param integer             $line
     */
    public function __construct($title, $description, array $tags, ?BackgroundNode $background, array $scenarios, $keyword, $language, $file, $line)
    {
