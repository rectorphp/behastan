 ...
 */
namespace Behastan202606\Behat\Gherkin\Filter;
            ...
            if ($scenario instanceof OutlineNode && $scenario->hasExamples()) {
                foreach ($scenario->getExampleTables() as $exampleTable) {
                    ...
                    if (in_array($this->filterLine, $lines)) {
                        ...
                        $scenario = new OutlineNode($scenario->getTitle(), $scenario->getTags(), $scenario->getSteps(), array(new ExampleTableNode($filteredTable, $exampleTable->getKeyword(), $exampleTable->getTags())), $scenario->getKeyword(), $scenario->getLine());
                    }
                }
            }
            $scenarios[] = $scenario;
