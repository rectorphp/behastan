...
class TagFilter extends ComplexFilter
{
    ...
    public function __construct($filterString)
    {
        ...
        if (preg_match('/\s/u', $this->filterString)) {
            trigger_error("Tags with whitespace are deprecated and may be removed in a future version", \E_USER_DEPRECATED);
        }
    }
    /**
    ...
    public function filterFeature(FeatureNode $feature)
    {
        ...
        foreach ($feature->getScenarios() as $scenario) {
            ...
            if ($scenario instanceof OutlineNode && $scenario->hasExamples()) {
                ...
                $scenario = new OutlineNode($scenario->getTitle(), $scenario->getTags(), $scenario->getSteps(), $exampleTables, $scenario->getKeyword(), $scenario->getLine());
            }
            $scenarios[] = $scenario;
        }
