 ...
 */
namespace Behastan202606\Behat\Gherkin;

use Behastan202606\Behat\Gherkin\Exception\LexerException;
use Behastan202606\Behat\Gherkin\Exception\NodeException;
use Behastan202606\Behat\Gherkin\Exception\ParserException;
...
class Parser
{
    ...
    protected function parseTags()
    {
        ...
        $possibleTransitions = array('Outline' => array('Examples', 'Step'));
        $currentType = '-1';
