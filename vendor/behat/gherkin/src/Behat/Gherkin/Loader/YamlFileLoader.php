...
use Behastan202606\Symfony\Component\Yaml\Yaml;
/**
 * Yaml files loader.
 *
...
class YamlFileLoader extends AbstractFileLoader
{
    ...
    {
        return is_string($path) && is_file($absolute = $this->findAbsolutePath($path)) && 'yml' === pathinfo($absolute, \PATHINFO_EXTENSION);
    }
    /**
