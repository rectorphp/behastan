...
use Behastan202606\Behat\Gherkin\Cache\CacheInterface;
use Behastan202606\Behat\Gherkin\Node\FeatureNode;
use Behastan202606\Behat\Gherkin\Parser;
/**
...
class GherkinFileLoader extends AbstractFileLoader
{
    ...
    {
        return is_string($path) && is_file($absolute = $this->findAbsolutePath($path)) && 'feature' === pathinfo($absolute, \PATHINFO_EXTENSION);
    }
    /**
