...
use Behastan202606\Behat\Gherkin\Node\PyStringNode;
use Behastan202606\Behat\Gherkin\Node\ScenarioNode;
use Behastan202606\Behat\Gherkin\Node\StepNode;
use Behastan202606\Behat\Gherkin\Node\TableNode;
/**
 * From-array loader.
 *
...
class ArrayLoader implements LoaderInterface
{
    ...
    {
        $hash = array_merge(array('title' => null, 'description' => null, 'tags' => array(), 'keyword' => 'Feature', 'language' => 'en', 'line' => $line, 'scenarios' => array()), $hash);
    ...
    {
        $hash = array_merge(array('title' => null, 'tags' => array(), 'keyword' => 'Scenario', 'line' => $line, 'steps' => array()), $hash);
        $steps = $this->loadStepsHash($hash['steps']);
    ...
    {
        $hash = array_merge(array('title' => null, 'tags' => array(), 'keyword' => 'Scenario Outline', 'line' => $line, 'steps' => array(), 'examples' => array()), $hash);
        $steps = $this->loadStepsHash($hash['steps']);
    ...
    {
        $hash = array_merge(array('keyword_type' => 'Given', 'type' => 'Given', 'text' => null, 'keyword' => 'Scenario', 'line' => $line, 'arguments' => array()), $hash);
        $arguments = array();
