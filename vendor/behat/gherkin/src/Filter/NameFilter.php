...
use Behastan202601\Behat\Gherkin\Node\DescribableNodeInterface;
...
class NameFilter extends SimpleFilter
{
    ...
    public function isFeatureMatch(FeatureNode $feature)
    {
        ...
        return strpos($feature->getTitle(), $this->filterString) !== \false;
    }
    /**
    ...
    public function isScenarioMatch(ScenarioInterface $scenario)
    {
        ...
        $textParts = array_filter([$scenario->getTitle(), $scenario instanceof DescribableNodeInterface ? $scenario->getDescription() : null]);
        if ($textParts === []) {
            return \false;
        }
        $textToMatch = implode("\n", $textParts);
        ...
        if (strpos($textToMatch, $this->filterString) !== \false) {
            return \true;
        }
        return \false;
    }
