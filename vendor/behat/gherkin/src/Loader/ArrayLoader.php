...
class ArrayLoader extends AbstractLoader
{
    ...
    {
        $hash = array_merge(['title' => null, 'description' => null, 'tags' => [], 'keyword' => 'Feature', 'language' => 'en', 'line' => $line, 'scenarios' => []], $hash);
    ...
    {
        $hash = array_merge(['title' => null, 'keyword' => 'Background', 'line' => 0, 'steps' => []], $hash);
    ...
    {
        $hash = array_merge(['title' => null, 'tags' => [], 'keyword' => 'Scenario', 'line' => $line, 'steps' => []], $hash);
        $steps = $this->loadStepsHash($hash['steps']);
    ...
    {
        $hash = array_merge(['title' => null, 'tags' => [], 'keyword' => 'Scenario Outline', 'line' => $line, 'steps' => [], 'examples' => []], $hash);
        $steps = $this->loadStepsHash($hash['steps']);
    ...
    {
        $hash = array_merge(['keyword_type' => 'Given', 'type' => 'Given', 'text' => null, 'keyword' => 'Scenario', 'line' => $line, 'arguments' => []], $hash);
        $arguments = [];
