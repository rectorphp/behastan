...
final class GherkinDialect
{
     ...
     */
    private $stepKeywordsCache;
    /**
     * @phpstan-param TDialectData $dialect
     */
    public function __construct(string $language, array $dialect)
    {
    ...
    public function getStepKeywords(): array
    {
        ...
        $stepKeywords = array_merge($this->getGivenKeywords(), $this->getWhenKeywords(), $this->getThenKeywords(), $this->getAndKeywords(), $this->getButKeywords());
