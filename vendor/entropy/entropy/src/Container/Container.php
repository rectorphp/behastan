...
namespace Behastan202512\Entropy\Container;

use Behastan202512\Entropy\Attributes\RelatedTest;
use Behastan202512\Entropy\Console\CommandRegistry;
use Behastan202512\Entropy\Console\Contract\CommandInterface;
use Behastan202512\Entropy\Container\Exception\CreateServiceException;
use Behastan202512\Entropy\Container\Exception\RegisterServiceException;
use Behastan202512\Entropy\Reflection\ParameterTypesResolver;
use Behastan202512\Entropy\Tests\Container\Container\ContainerTest;
use ReflectionClass;
...
final class Container
{
    ...
    public function __construct()
    {
        ...
        $this->service(CommandRegistry::class, function (Container $container): \Behastan202512\Entropy\Console\CommandRegistry {
