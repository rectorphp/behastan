...
namespace Behastan202601\Entropy\Container;

use Behastan202601\Entropy\Attributes\RelatedTest;
use Behastan202601\Entropy\Console\CommandRegistry;
use Behastan202601\Entropy\Console\Contract\CommandInterface;
use Behastan202601\Entropy\Container\Exception\CreateServiceException;
use Behastan202601\Entropy\Container\Exception\RegisterServiceException;
use Behastan202601\Entropy\Reflection\ParameterTypesResolver;
use Behastan202601\Entropy\Tests\Container\Container\ContainerTest;
use ReflectionClass;
...
final class Container
{
    ...
    public function __construct()
    {
        ...
        $this->service(CommandRegistry::class, function (Container $container): \Behastan202601\Entropy\Console\CommandRegistry {
