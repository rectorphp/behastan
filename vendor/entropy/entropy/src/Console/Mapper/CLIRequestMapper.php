...
namespace Behastan202512\Entropy\Console\Mapper;

use Behastan202512\Entropy\Attributes\RelatedTest;
use Behastan202512\Entropy\Console\Contract\CommandInterface;
use Behastan202512\Entropy\Console\Exception\ConsoleInputMappingException;
use Behastan202512\Entropy\Console\ValueObject\CLIRequest;
use Behastan202512\Entropy\Tests\Console\Mapper\CLIRequestMapperTest;
...
final class CLIRequestMapper
{
     ...
     * @return mixed
     */
    private function castValueByParameterType($value, ?ReflectionType $reflectionType)
    {
