...
use Behastan202512\PhpParser\Internal\DiffElem;
use Behastan202512\PhpParser\Internal\Differ;
use Behastan202512\PhpParser\Internal\PrintableNewAnonClassNode;
use Behastan202512\PhpParser\Internal\TokenStream;
use Behastan202512\PhpParser\Node\AttributeGroup;
use Behastan202512\PhpParser\Node\Expr;
use Behastan202512\PhpParser\Node\Expr\AssignOp;
use Behastan202512\PhpParser\Node\Expr\BinaryOp;
use Behastan202512\PhpParser\Node\Expr\Cast;
use Behastan202512\PhpParser\Node\IntersectionType;
use Behastan202512\PhpParser\Node\MatchArm;
use Behastan202512\PhpParser\Node\Param;
use Behastan202512\PhpParser\Node\PropertyHook;
use Behastan202512\PhpParser\Node\Scalar;
use Behastan202512\PhpParser\Node\Stmt;
use Behastan202512\PhpParser\Node\UnionType;
