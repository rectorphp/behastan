...
use Behastan202606\PhpParser\Internal\DiffElem;
use Behastan202606\PhpParser\Internal\Differ;
use Behastan202606\PhpParser\Internal\PrintableNewAnonClassNode;
use Behastan202606\PhpParser\Internal\TokenStream;
use Behastan202606\PhpParser\Node\AttributeGroup;
use Behastan202606\PhpParser\Node\Expr;
use Behastan202606\PhpParser\Node\Expr\AssignOp;
use Behastan202606\PhpParser\Node\Expr\BinaryOp;
use Behastan202606\PhpParser\Node\Expr\Cast;
use Behastan202606\PhpParser\Node\IntersectionType;
use Behastan202606\PhpParser\Node\MatchArm;
use Behastan202606\PhpParser\Node\Param;
use Behastan202606\PhpParser\Node\PropertyHook;
use Behastan202606\PhpParser\Node\Scalar;
use Behastan202606\PhpParser\Node\Stmt;
use Behastan202606\PhpParser\Node\UnionType;
