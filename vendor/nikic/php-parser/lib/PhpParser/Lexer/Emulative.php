...
namespace Behastan202512\PhpParser\Lexer;

use Behastan202512\PhpParser\Error;
use Behastan202512\PhpParser\ErrorHandler;
use Behastan202512\PhpParser\Lexer;
use Behastan202512\PhpParser\Lexer\TokenEmulator\AsymmetricVisibilityTokenEmulator;
use Behastan202512\PhpParser\Lexer\TokenEmulator\AttributeEmulator;
use Behastan202512\PhpParser\Lexer\TokenEmulator\EnumTokenEmulator;
use Behastan202512\PhpParser\Lexer\TokenEmulator\ExplicitOctalEmulator;
use Behastan202512\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator;
use Behastan202512\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator;
use Behastan202512\PhpParser\Lexer\TokenEmulator\PipeOperatorEmulator;
use Behastan202512\PhpParser\Lexer\TokenEmulator\PropertyTokenEmulator;
use Behastan202512\PhpParser\Lexer\TokenEmulator\ReadonlyFunctionTokenEmulator;
use Behastan202512\PhpParser\Lexer\TokenEmulator\ReadonlyTokenEmulator;
use Behastan202512\PhpParser\Lexer\TokenEmulator\ReverseEmulator;
use Behastan202512\PhpParser\Lexer\TokenEmulator\TokenEmulator;
use Behastan202512\PhpParser\Lexer\TokenEmulator\VoidCastEmulator;
