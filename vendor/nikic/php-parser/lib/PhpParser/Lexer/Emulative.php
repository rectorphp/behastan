...
namespace Behastan202606\PhpParser\Lexer;

use Behastan202606\PhpParser\Error;
use Behastan202606\PhpParser\ErrorHandler;
use Behastan202606\PhpParser\Lexer;
use Behastan202606\PhpParser\Lexer\TokenEmulator\AsymmetricVisibilityTokenEmulator;
use Behastan202606\PhpParser\Lexer\TokenEmulator\AttributeEmulator;
use Behastan202606\PhpParser\Lexer\TokenEmulator\EnumTokenEmulator;
use Behastan202606\PhpParser\Lexer\TokenEmulator\ExplicitOctalEmulator;
use Behastan202606\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator;
use Behastan202606\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator;
use Behastan202606\PhpParser\Lexer\TokenEmulator\PipeOperatorEmulator;
use Behastan202606\PhpParser\Lexer\TokenEmulator\PropertyTokenEmulator;
use Behastan202606\PhpParser\Lexer\TokenEmulator\ReadonlyFunctionTokenEmulator;
use Behastan202606\PhpParser\Lexer\TokenEmulator\ReadonlyTokenEmulator;
use Behastan202606\PhpParser\Lexer\TokenEmulator\ReverseEmulator;
use Behastan202606\PhpParser\Lexer\TokenEmulator\TokenEmulator;
use Behastan202606\PhpParser\Lexer\TokenEmulator\VoidCastEmulator;
use Behastan202606\PhpParser\PhpVersion;
use Behastan202606\PhpParser\Token;
