...
namespace Behastan202601\PhpParser\Lexer;

use Behastan202601\PhpParser\Error;
use Behastan202601\PhpParser\ErrorHandler;
use Behastan202601\PhpParser\Lexer;
use Behastan202601\PhpParser\Lexer\TokenEmulator\AsymmetricVisibilityTokenEmulator;
use Behastan202601\PhpParser\Lexer\TokenEmulator\AttributeEmulator;
use Behastan202601\PhpParser\Lexer\TokenEmulator\EnumTokenEmulator;
use Behastan202601\PhpParser\Lexer\TokenEmulator\ExplicitOctalEmulator;
use Behastan202601\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator;
use Behastan202601\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator;
use Behastan202601\PhpParser\Lexer\TokenEmulator\PipeOperatorEmulator;
use Behastan202601\PhpParser\Lexer\TokenEmulator\PropertyTokenEmulator;
use Behastan202601\PhpParser\Lexer\TokenEmulator\ReadonlyFunctionTokenEmulator;
use Behastan202601\PhpParser\Lexer\TokenEmulator\ReadonlyTokenEmulator;
use Behastan202601\PhpParser\Lexer\TokenEmulator\ReverseEmulator;
use Behastan202601\PhpParser\Lexer\TokenEmulator\TokenEmulator;
use Behastan202601\PhpParser\Lexer\TokenEmulator\VoidCastEmulator;
use Behastan202601\PhpParser\PhpVersion;
use Behastan202601\PhpParser\Token;
