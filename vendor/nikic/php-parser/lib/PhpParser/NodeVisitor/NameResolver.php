...
namespace Behastan202512\PhpParser\NodeVisitor;

use Behastan202512\PhpParser\ErrorHandler;
use Behastan202512\PhpParser\NameContext;
use Behastan202512\PhpParser\Node;
...
use Behastan202512\PhpParser\NodeVisitorAbstract;
