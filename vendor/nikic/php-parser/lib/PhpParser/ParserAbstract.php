...
namespace Behastan202606\PhpParser;

/*
 * This parser is based on a skeleton written by Moriyoshi Koizumi, which in
 * turn is based on work by Masato Bito.
 */
use Behastan202606\PhpParser\Node\Arg;
use Behastan202606\PhpParser\Node\Expr;
use Behastan202606\PhpParser\Node\Expr\Array_;
use Behastan202606\PhpParser\Node\Expr\Cast\Double;
use Behastan202606\PhpParser\Node\Identifier;
use Behastan202606\PhpParser\Node\InterpolatedStringPart;
use Behastan202606\PhpParser\Node\Name;
use Behastan202606\PhpParser\Node\Param;
use Behastan202606\PhpParser\Node\PropertyHook;
use Behastan202606\PhpParser\Node\Scalar\InterpolatedString;
use Behastan202606\PhpParser\Node\Scalar\Int_;
use Behastan202606\PhpParser\Node\Scalar\String_;
use Behastan202606\PhpParser\Node\Stmt;
use Behastan202606\PhpParser\Node\Stmt\Class_;
use Behastan202606\PhpParser\Node\Stmt\ClassConst;
use Behastan202606\PhpParser\Node\Stmt\ClassMethod;
use Behastan202606\PhpParser\Node\Stmt\Const_;
use Behastan202606\PhpParser\Node\Stmt\Else_;
use Behastan202606\PhpParser\Node\Stmt\ElseIf_;
use Behastan202606\PhpParser\Node\Stmt\Enum_;
use Behastan202606\PhpParser\Node\Stmt\Interface_;
use Behastan202606\PhpParser\Node\Stmt\Namespace_;
use Behastan202606\PhpParser\Node\Stmt\Nop;
use Behastan202606\PhpParser\Node\Stmt\Property;
use Behastan202606\PhpParser\Node\Stmt\TryCatch;
use Behastan202606\PhpParser\Node\UseItem;
use Behastan202606\PhpParser\Node\VarLikeIdentifier;
use Behastan202606\PhpParser\NodeVisitor\CommentAnnotatingVisitor;
