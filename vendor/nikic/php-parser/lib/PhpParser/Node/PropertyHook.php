...
use Jack202512\PhpParser\Modifiers;
use Jack202512\PhpParser\Node\Expr\Assign;
use Jack202512\PhpParser\Node\Expr\PropertyFetch;
use Jack202512\PhpParser\Node\Expr\Variable;
use Jack202512\PhpParser\Node\Stmt\Expression;
use Jack202512\PhpParser\Node\Stmt\Return_;
use Jack202512\PhpParser\NodeAbstract;
