...
namespace Behastan202512\PhpParser\Node;

use Behastan202512\PhpParser\Modifiers;
use Behastan202512\PhpParser\Node\Expr\Assign;
use Behastan202512\PhpParser\Node\Expr\PropertyFetch;
use Behastan202512\PhpParser\Node\Expr\Variable;
use Behastan202512\PhpParser\Node\Stmt\Expression;
use Behastan202512\PhpParser\Node\Stmt\Return_;
use Behastan202512\PhpParser\NodeAbstract;
