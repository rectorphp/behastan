...
namespace Behastan202601\PhpParser\Node;

use Behastan202601\PhpParser\Modifiers;
use Behastan202601\PhpParser\Node\Expr\Assign;
use Behastan202601\PhpParser\Node\Expr\PropertyFetch;
use Behastan202601\PhpParser\Node\Expr\Variable;
use Behastan202601\PhpParser\Node\Stmt\Expression;
use Behastan202601\PhpParser\Node\Stmt\Return_;
use Behastan202601\PhpParser\NodeAbstract;
